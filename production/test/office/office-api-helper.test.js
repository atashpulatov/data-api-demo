...
import { IncorrectInputTypeError } from '../../src/office/incorrect-input-type';
import { OfficeError, OfficeBindingError } from '../../src/office/office-error';
...
describe.skip('OfficeApiHelper', () => {
    ...
    it('should find proper office table id with only a-z characters', async () => {
        ...
        // then
        expect(/^[a-zA-Z]+0$/.test(parsedReportName)).toBeTruthy();
    });
