...
export const stringMessageToErrorType = withDefaultValue(
  {
    ...
    [incomingErrorStrings.BINDING_NOT_VALID]:
      errorTypes.TABLE_REMOVED_FROM_EXCEL_ERR,
    [incomingErrorStrings.RESOURCE_NOT_EXIST]:
      errorTypes.TABLE_REMOVED_FROM_EXCEL_ERR,
...
export const errorMessages = {
  ...
  ALL_DATA_FILTERED_OUT:
    "No data returned for this view. This might be because the applied prompt excludes all data.",
  EMPTY_REPORT: "You cannot import an empty object.",
  NO_DATA_RETURNED:
    "This object cannot be imported. Either you do not have necessary permissions to view it, or it is empty.",
  NOT_SUPPORTED_SERVER_ERR:
    "This object cannot be imported. Objects with cross tabs, totals, or subtotals are not supported in this version of MicroStrategy for Office.",
  NOT_SUPPORTED_PROMPTS_REFRESH:
    "Objects with prompts cannot be refreshed in this version of MicroStrategy for Office.",
  NOT_PUBLISHED_CUBE: "You cannot import an unpublished cube.",
  NO_DATA_SELECTED:
    "This button is currently disabled because you didn’t select any data",
  NOT_IN_METADATA:
    "The object no longer exists, it has been removed from the data source.",
  PROJECT_ROW_LIMIT:
    "This object exceeds the MicroStrategy project row limit. Please contact your administrator.",
  TABLE_OVERLAP:
    "This operation requires the use of additional empty rows or columns.",
  ERROR_POPUP_CLOSED: "Function close call failed, error code:",
  NOT_SUPPORTED_CUSTOM_GROUP:
    "This object cannot be imported. Objects with custom groups are not supported in this version of MicroStrategy for Office.",
  TABLE_REMOVED:
    "It looks like the object was deleted from the workbook. Delete it in the sidebar or click Add Data to import it again.",
  ENDPOINT_NOT_REACHED: "The endpoint cannot be reached",
  EXCEEDS_WORKSHEET_LIMITS:
    "The table you try to import exceeds the worksheet limits.",
  EXCEEDS_EXCEL_API_LIMITS:
    "Import failed because the payload size limit for any Excel Online request or response is 5MB. Try to limit your data.",
  OUTSIDE_OF_OFFICE: "Please run plugin inside Office",
  CONNECTION_BROKEN:
    "Environment is unreachable. Please check your internet connection.",
  ...
  VISUALIZATION_REMOVED_FROM_EXCEL:
    "Could not complete the operation. The image was deleted manually.",
  SHEET_HIDDEN: "To view the data, please unhide the worksheet.",
  PROTECTED_SHEET:
    "The table you are trying to manipulate is in a protected sheet. To make a change, unprotect the sheet. You might be requested to enter a password.",
  NOT_SUPPORTED_VIZ:
    "Selected visualization cannot be imported in current version of the Add-in",
  INVALID_VIZ_KEY_MESSAGE:
    "You are trying to perform an operation on a visualization that is either not supported or deleted from the dossier.",
  SESSION_EXTENSION_FAILURE_MESSAGE:
    "The user's session has expired, please reauthenticate",
  DOSSIER_HAS_CHANGED:
    "The object cannot be refreshed because the dossier has changed. You can edit the object or remove it.",
...
export const handleUnauthorizedError = (error) => {
  ...
  if (
    ...
    iServerErrorMessages(error.response.body.iServerCode) ===
      errorMessages.LOGIN_FAILURE
  ) {
...
export const errorMessageFactory = withDefaultValue(
  {
    ...
    [errorTypes.INTERNAL_SERVER_ERR]: ({ error }) =>
    ...
    [errorTypes.OUTSIDE_OF_RANGE_ERR]: () =>
      errorMessages.EXCEEDS_WORKSHEET_LIMITS,
    ...
    [errorTypes.TABLE_REMOVED_FROM_EXCEL_ERR]: () =>
      errorMessages.OBJ_REMOVED_FROM_EXCEL,
    [errorTypes.IMAGE_REMOVED_FROM_EXCEL_ERR]: () =>
      errorMessages.VISUALIZATION_REMOVED_FROM_EXCEL,
