...
export const INVALID_VIZ_KEY_MESSAGE = 'You are trying to perform an operation on a visualization that is either not supported, moved to a different chapter, or deleted from the dossier.';
