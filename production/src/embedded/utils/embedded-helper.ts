 ...
 * @param {*} Office
 */
export const handleLoginExcelDesktopInWindows = (contentDocument: Document, Office: any): void => {
  if (!scriptInjectionHelper.isLoginPage(contentDocument)) {
    ...
    const isOfficeOnline =
      Office.context && Office.context.platform === Office.PlatformType.OfficeOnline;
