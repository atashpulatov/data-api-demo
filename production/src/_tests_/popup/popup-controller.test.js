...
import overviewHelper, {
  OverviewActionCommands,
} from "../../popup/overview/overview-helper";
...
describe("PopupController", () => {
  ...
  it("should call displayDialogAsync on runPopup invocation", async () => {
    ...
    jest
      ...
      .mockImplementationOnce(() => {});
    jest
      .spyOn(popupController, "onMessageFromPopup")
      .mockImplementationOnce(() => {});
    jest
      .spyOn(officeApiHelper, "getExcelSessionStatus")
      .mockImplementationOnce(() => {});
    // when
  ...
  it("should handle ok command from popup for report WITHOUT instance id", async () => {
    ...
    const handleOkCommandSpy = jest
      .spyOn(popupController, "handleOkCommand")
      .mockImplementation();
  ...
  `(
    "should call handleOverviewActionCommand for overview actions",
    async ({ actionCommand }) => {
      // given
      const actionObject = {
      ...
      jest
        .spyOn(
          officeReducerHelper,
          "getObjectFromObjectReducerByObjectWorkingId"
        )
