...
describe("Normalized JSON Handler", () => {
  ...
  it("should map indices to elements", () => {
    ...
    // when
    const elements = jsonHandler.mapElementIndicesToElements({
      definition,
      axis,
      headerCells,
    });
  ...
  it("should get element id for a given cell", () => {
    ...
    // when
    const tabular = jsonHandler.getElementIdForGivenHeaderCell(
      definition,
      axis,
      attributeIndex,
      headerIndex
  ...
  it("should render column headers", () => {
    ...
    // when
    const colHeaders = jsonHandler.renderHeaders(
      definition,
      axis,
      headers,
      onElement
