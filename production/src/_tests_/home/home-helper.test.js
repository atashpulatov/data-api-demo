...
describe("HomeHelper", () => {
  ...
  describe("saveLoginValues", () => {
    ...
    it("prepare envUrl and save it to store", () => {
      ...
      jest.spyOn(homeHelper, "getWindowLocation").mockReturnValueOnce({
        ...
        pathname:
          "MicroStrategyLibrary/apps/addin-mstr-office/index.html?source=addin-mstr-office",
      });
      sessionActions.logOut = jest.fn();
      jest
        .spyOn(reduxStore, "getState")
  ...
  describe("getParsedCookies", () => {
    it("should cookie", () => {
      ...
      jest
        .spyOn(homeHelper, "getDocumentCookie")
        .mockReturnValueOnce(exampleCookies);
      // when
  ...
  describe("storeShowHidden", () => {
    ...
    `(
      ...
      ({ excelSettingValue, localStorageValue, expectedShowHiddenPayload }) => {
        ...
        jest
          .spyOn(homeHelper, "getStorageItem")
          .mockReturnValue(localStorageValue);
        ...
        // then
        expect(actionPayloadSpy).toHaveBeenCalledWith(
          expectedShowHiddenPayload
        );
  ...
  describe("secureData()", () => {
    it("should skip clearDataRequested() dispatch for image object.", async () => {
      ...
      jest
        .spyOn(officeApiWorksheetHelper, "checkIfAnySheetProtected")
        .mockImplementation();
