import {
  mergeHeaderColumns,
  mergeHeaderRows,
} from "../../office/api/office-api-header-merge-helper";
  ...
  `(
    ...
    ({
      ...
      if (noOfMerges > 0) {
        ...
        expect(rangeFormat.horizontalAlignment).toEqual(
  ...
  `(
    ...
    ({
      ...
      if (noOfMerges > 0) {
        expect(offsetRange).toEqual(resultOffsetRange);
        expect(resizedRangeDelta).toEqual(resultResizedRangeDelta);
        expect(rangeFormat.verticalAlignment).toEqual(
