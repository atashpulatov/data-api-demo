...
describe("StepRemoveVisualizationImage", () => {
    ...
    workbook: {
      worksheets: {
        getItem: jest.fn().mockImplementation((_worksheetId) => ({
          shapes: {
            addGeometricShape: jest
              .fn()
              .mockImplementation((_geometricShapeType) => {
                throw error;
              }),
          },
        })),
  ...
  it("addGeometricShape should throw an error.", async () => {
    ...
    jest
      .spyOn(operationStepDispatcher, "completeRemoveVisualizationImage")
      .mockImplementation();
    ...
    expect(
      operationStepDispatcher.completeRemoveVisualizationImage
