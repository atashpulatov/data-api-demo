...
describe("OfficeStoreHelper getters", () => {
  ...
  `(
    ...
    ({ expectedPropertyName, setterNameParam }) => {
      ...
      expect(officeStoreHelper.setPropertyValue).toBeCalledWith(
  ...
  `(
    ...
    ({ propertyNameParam, getterNameParam }) => {
      // given
      jest
        .spyOn(officeStoreHelper, "getPropertyValue")
        .mockReturnValue("valueTest");
      ...
      expect(officeStoreHelper.getPropertyValue).toBeCalledWith(
        propertyNameParam
      );
