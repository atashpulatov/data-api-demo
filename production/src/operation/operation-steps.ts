...
export enum OperationSteps {
  ...
  GET_DEFAULT_OFFICE_TABLE_TEMPLATE_IMPORT = 'GET_DEFAULT_OFFICE_TABLE_CREATE',
  GET_DEFAULT_OFFICE_TABLE_TEMPLATE_EDIT_REFRESH = 'GET_DEFAULT_OFFICE_TABLE_TEMPLATE_EDIT_REFRESH',
