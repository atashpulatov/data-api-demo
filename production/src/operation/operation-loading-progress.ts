...
const loadingStateEnumWeights = {
  ...
  [ObjectImportType.FORMATTED_DATA]: {
    [OperationTypes.IMPORT_OPERATION]: {
      ...
      GET_OBJECT_DETAILS: 10,
      EXPORT_EXCEL_WORKBOOK: 30,
      GET_FORMATTED_DATA_TABLE_IMPORT: 40,
      IMPORT_EXPORTED_WORKSHEET_TO_CURRENT_WORKBOOK: 50,
      MOVE_FORMATTED_DATA_FROM_EXPORTED_TO_TARGET_WORKSHEET: 60,
      FORMAT_OFFICE_TABLE: 70,
    ...
    [OperationTypes.REFRESH_OPERATION]: {
      ...
      EXPORT_EXCEL_WORKBOOK: 40,
      GET_FORMATTED_DATA_TABLE_EDIT_REFRESH: 50,
      IMPORT_EXPORTED_WORKSHEET_TO_CURRENT_WORKBOOK: 60,
      MOVE_FORMATTED_DATA_FROM_EXPORTED_TO_TARGET_WORKSHEET: 70,
    ...
    [OperationTypes.DUPLICATE_OPERATION]: {
      ...
      EXPORT_EXCEL_WORKBOOK: 50,
      GET_FORMATTED_DATA_TABLE_IMPORT: 60,
      IMPORT_EXPORTED_WORKSHEET_TO_CURRENT_WORKBOOK: 70,
      MOVE_FORMATTED_DATA_FROM_EXPORTED_TO_TARGET_WORKSHEET: 80,
      FORMAT_OFFICE_TABLE: 80,
      BIND_OFFICE_TABLE: 80,
      SAVE_OBJECT_IN_EXCEL: 80,
      DISPLAY_NOTIFICATION_COMPLETED: 100,
