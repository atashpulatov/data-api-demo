...
const loadingStateEnumWeights = {
  [objectImportType.TABLE]: {
    ...
    [EDIT_OPERATION]: {
      ...
      GET_OBJECT_DETAILS: 15,
      GET_OFFICE_TABLE_EDIT_REFRESH: 20,
      FETCH_INSERT_DATA: 25,
      FORMAT_DATA: 25,
      FORMAT_OFFICE_TABLE: 30,
      FORMAT_SUBTOTALS: 40,
      BIND_OFFICE_TABLE: 50,
      SAVE_OBJECT_IN_EXCEL: 60,
      DISPLAY_NOTIFICATION_COMPLETED: 95,
      EXECUTE_NEXT_REPROMPT: 100,
    },
    [DUPLICATE_OPERATION]: {
      MODIFY_OBJECT: 0,
