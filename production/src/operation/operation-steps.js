...
export const EXECUTE_NEXT_REPROMPT = 'EXECUTE_NEXT_REPROMPT';
...
// shape steps
export const MANIPULATE_VISUALIZATION_IMAGE = 'MANIPULATE_VISUALIZATION_IMAGE';
export const REMOVE_VISUALIZATION_IMAGE = 'REMOVE_VISUALIZATION_IMAGE';
export const ADD_VISUALIZATION_PLACEHOLDER = 'ADD_VISUALIZATION_PLACEHOLDER';
export const SAVE_IMAGE_DETAILS = 'SAVE_IMAGE_DETAILS';
...
const operationStepsMapTable = {
  ...
  [HIGHLIGHT_OPERATION]: [HIGHLIGHT_OBJECT],
