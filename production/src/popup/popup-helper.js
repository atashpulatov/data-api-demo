...
class PopupHelper {
    ...
    printRefreshedReport = async (bindingId, objectType, length, index, isRefreshAll) => {
      ...
      const result = await officeDisplayService.printObject(instanceId, refreshReport.id, refreshReport.projectId, isReport,
          true, refreshReport.tableId, bindingId, refreshReport.body, true, false, isRefreshAll);
