...
const prepareButton = (disableActiveActions, button, t) => {
  return disableActiveActions ?
    <Popover className='button-tooltip' placement="top" content={t('This button is currently disabled because you didn’t select any data')} mouseEnterDelay={1} style={{color: '#FFF'}}>
      {button}
    </Popover> : button;
};
