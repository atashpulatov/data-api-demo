...
[![Build Status](https://jenkins.internal.microstrategy.com/buildStatus/icon?job=mstr-office-.-m2019_update-.-stage-1-dev)](https://jenkins.internal.microstrategy.com/job/mstr-office-.-m2019_update-.-stage-1-dev/)
...
## Manually uploading addin ro AWS instance and uploading the test data
...
2. choose a branch folder (e.g. “m2019-update”)
3. get addin
    1. find folder “office”
    2. choose a version folder (e.g. “11.1.3.1050”)
    3. click file ending in “.zip”
    4. download link for plugin is on the pain to the right under “Path”
4. get addin loader
...
1. connect to the developer instance of the env
2. copy the addin and addin loader downloaded from Nexus to the env and extract them
3. Open WinSCP
...
5. upload the addin
    ...
    3. select all files on the left and copy them to the right
...
3. open up Object Manager
    1. Open Project Source select “MicroStrategy on AWS I-Server”
    2. click “Open”
    3. login with the credentials from:”Welcome to MicroStrategy on AWS” email
    4. click on “MicroStrategy Tutorial” project
    5. under “Tools” press “Import Package…”
    6. in the new prompt click the “…” button
    7. find the test objects unzipped folder and select “ProjectPackage with all test objects.mmp”
    8. click “Proceed” button
4. open WinSCP
    1. click login (if first time login see “Upload office addin and addin loader to the Env”)
    2. on the right open up “opt/mstr/MicroStrategy/IntelligenceServer“
    3. for Cubes
        ...
        4. copy all files from the folder on the left to the one on the right
