...
from pages.duplicate_object_popup.duplicate_object_popup_mac_desktop_page import (
...
from pages.excel.excel_sheet.excel_sheet_mac_desktop_page import (
    ExcelSheetMacDesktopPage,
)
from pages.excel.start_excel.start_excel_mac_desktop_page import (
    StartExcelMacDesktopPage,
)
from pages.import_data_popup.import_data_popup_mac_desktop_page import (
    ImportDataPopupMacDesktopPage,
)
from pages.not_logged_right_panel.not_logged_right_panel_mac_desktop_page import (
    NotLoggedRightPanelMacDesktopPage,
)
from pages.right_panel.right_panel.right_panel_mac_desktop_page import (
    RightPanelMacDesktopPage,
)
from pages.right_panel.right_panel_tile.right_panel_tile_mac_desktop_page import (
    RightPanelTileMacDesktopPage,
)
...
class PagesSetMacDesktop(AbstractPagesSet):
    def __init__(self):
        ...
        self.duplicate_object_popup_mac_desktop_page = (
            DuplicateObjectPopupMacDesktopPage()
        )
        self.not_logged_right_panel_mac_desktop_page = (
            NotLoggedRightPanelMacDesktopPage()
        )
        self.columns_and_filters_selection_mac_desktop_page = (
            ColumnsAndFiltersSelectionMacDesktopPage()
        )
