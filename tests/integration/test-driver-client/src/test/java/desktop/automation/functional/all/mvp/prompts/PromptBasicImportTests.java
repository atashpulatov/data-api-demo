package desktop.automation.functional.all.mvp.prompts;
...
//        Thread.sleep(10_000);//TODO
        ...
        //assertTrue(machine.isButtonEnabled(cancelBtn));
        //assertFalse(machine.isButtonEnabled(runBtn));
        ...
        //assertions
//        assertTrue(machine.isButtonEnabled(cancelBtn));
//        assertTrue(machine.isButtonEnabled(runBtn));
...
//  PromptBasicImportTests.bigDecimalNotReq
//  PromptBasicImportTests.hierarchyNotReqDefault
    //TC40297
    @Test
    public void bigDecimalNotReq(){
        //test case does not mention that input should be provided, but formulated automation with it implied.
...
//        assertTrue(machine.isButtonEnabled(runBtn));
    ...
    //TC40299
    @Test
    public void objectReqDefault() throws InterruptedException {
...
//        assertTrue(machine.isButtonEnabled(cancelBtn));
    ...
    //TC40365
    @Test
    //Nested report , prompts: 1) objects prompt 2) hierarchy?
...
//      assert imported successfully
    ...
    public void attributeQualificationNoDefault(){
        ...
        //prompt
//        machine.getAttributeQualifcationPromptPage().getAttributeSelectionDropDownElem().click();
//        machine.getAttributeQualifcationPromptPage().getAttributeSelectionOptionElems().get(0).click();
