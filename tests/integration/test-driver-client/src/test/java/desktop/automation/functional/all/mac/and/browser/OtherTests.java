...
//        assertTrue(machine.isButtonEnabled());
    ...
    //TC48339
    @Test
    public void editNonFilteredDataset() throws InterruptedException {
...
//                {"I732", "8"}
    ...
    //TC48529
    @Test
    public void importReportCrosstabAndPrompt() throws InterruptedException {
...
//        assertTrue(machine.isButtonEnabled(runBtn));
        ...
        //assert 1) headers in cols, 2) in rows, 3)values
...
//        WebElement cancelBtn = machine.getStandardPromptPage().getCancelBtnElem();
        machine.getStandardPromptPage().getRunBtnElem();
...
//        assertTrue(machine.isButtonEnabled(runBtn));
        ...
        //assert cell values
        machine.getMainPage().assertCellValues(new String[][]{{"A2", "1820"}/*, {"B2", "$688"}*/});
    }
}
