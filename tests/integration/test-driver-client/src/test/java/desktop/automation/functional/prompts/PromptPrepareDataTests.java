package desktop.automation.functional.prompts;
...
//      assert imported successfully
    ...
    public void prepareDataDateAndTime(){
        ...
        machine.getDatePromptPage().answerPromptCorretly();
    ...
    public void prepareDataNumeric(){
        ...
        machine.getNumericPromptPage().answerPromptCorretly();
    ...
    public void prepareDataText() {
        ...
        // prompt
        machine.getTextValuePromptPage().answerPromptCorretly();
    ...
    public void prepareDataBigDecimal(){
        ...
        machine.getBigDecimalPromptPage().answerPromptCorretly();
    ...
    public void prepareDataAttributeElem(){
        ...
        machine.getAttributeElementPromptPage().answerPromptCorretly();
    ...
    public void prepareDataObject(){
        ...
        machine.getObjectPromptPage().answerPromptCorretly();
    ...
    public void prepareDataHierarchyQualification(){
        ...
        machine.getHierarchyQualificationPromptPage().answerPromptCorretly();
    ...
    public void prepareDataAttributeQualification(){
        ...
        machine.getAttributeQualificationPromptPage().answerPromptCorretly();
