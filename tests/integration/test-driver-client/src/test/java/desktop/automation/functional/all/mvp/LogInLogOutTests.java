package desktop.automation.functional.all.mvp;
...
import static desktop.automation.ConfigVars.EXCEL_ADD_IN_TEST_USER_PASS;
...
public class LogInLogOutTests extends BaseCommonTests {
    ...
    public void loginPositive() throws InterruptedException, IOException {
        ...
        if (machine.isBrowser())
            browser.switchToLoginPopUpElem();
        ...
        String expectedUserInitials ="A";
        machine.getMoreItemMenuPage().assertUserInitialsAndUserName(EXCEL_ADD_IN_TEST_USER_NAME, expectedUserInitials);
    }
