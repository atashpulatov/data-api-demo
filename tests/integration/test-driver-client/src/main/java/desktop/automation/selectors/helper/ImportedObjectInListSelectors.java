...
public class ImportedObjectInListSelectors {
    ...
    protected static final By IMPORTED_OBJECT_TEXT_ELEMS;
    ...
    static{
        switch (DESIRED_DRIVER_TYPE){
            case BROWSER:
                ...
                IMPORTED_OBJECT_TEXT_ELEMS = null;
            ...
            case MAC_DESKTOP:
                ...
                IMPORTED_REPORT_ICON_ELEM = null;
                IMPORTED_DATASET_ICON_ELEM = null;
                IMPORTED_OBJECT_TEXT_ELEMS = By.xpath("//AXStaticText");
            ...
            case WINDOWS_DESKTOP:
                ...
                IMPORTED_OBJECT_TEXT_ELEMS = By.xpath(".//*[@LocalizedControlType='text'][2]");
