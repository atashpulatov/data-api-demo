...
import desktop.automation.selectors.SUT.BrowserPageSelectors;
...
public abstract class BrowserPage extends BrowserPageSelectors {
    ...
    public BrowserPage(Machine machine) {
...
//            if (machine.getDriverType().equals(DriverType.MAC_DESKTOP)){
//                try {
//                    machine.actions
//                            .moveToElement(getCloseConfirmationPopupElem().getDriverElement(), 385, 125)
//                            .click();
