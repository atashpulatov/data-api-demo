...
class RightPanelMainMacDesktopPage(BaseMacDesktopPage):
    ...
    ADD_DATA_BUTTON_ELEM = BaseMacDesktopPage.RIGHT_SIDE_PANEL_ELEM + \
        "/AXButton[@AXTitle='Add Data' and @AXDOMIdentifier='add-data-btn']"

    DOTS_MENU = BaseMacDesktopPage.RIGHT_SIDE_PANEL_ELEM + "/AXGroup[1]/AXButton[0]/AXGroup"

    CLEAR_DATA = BaseMacDesktopPage.RIGHT_SIDE_PANEL_ELEM + \
        "/AXGroup[2]/AXGroup[@AXSubrole='AXContentList']/AXMenuItem[@AXTitle='Clear Data']"

    CONFIFRM_CLEAR_DATA = BaseMacDesktopPage.RIGHT_SIDE_PANEL_ELEM + \
        "/AXGroup[2]/AXButton[@AXTitle='OK' and @AXDOMIdentifier='confirm-btn']"

    VIEW_DATA_BUTTON_ELEM = BaseMacDesktopPage.RIGHT_SIDE_PANEL_ELEM + \
        "/AXGroup[@AXSubrole='AXApplicationDialog']/AXGroup[3]/AXButton[0]"
