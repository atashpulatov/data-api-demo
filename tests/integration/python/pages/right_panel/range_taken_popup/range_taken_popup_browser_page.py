...
class RangeTakenPopupBrowserPage(BaseBrowserPage):
    RANGE_TAKEN_OK_BUTTON = '.base-popup-footer-buttons .mstr-rc-3-button--primary'
    RANGE_TAKEN_CANCEL_BUTTON = '.base-popup-footer-buttons .mstr-rc-3-button--secondary'
