...
class ColumnsAndFiltersSelectionMacDesktopPage(BaseMacDesktopPage):
    ...
    def click_attribute(self, attribute_name):
        unchecked_attribute_checkbox = ColumnsAndFiltersSelectionMacDesktopPage.ATTRIBUTE_CHECKBOX_UNCHECKED % attribute_name

        checked_attribute_checkbox = ColumnsAndFiltersSelectionMacDesktopPage.ATTRIBUTE_CHECKBOX_CHECKED % attribute_name
        ...
        if self.check_if_element_exists_by_xpath(unchecked_attribute_checkbox, timeout=DEFAULT_WAIT_BETWEEN_CHECKS):
            ...
            self.get_element_by_xpath(checked_attribute_checkbox).click()
    ...
    def click_display_attributes_names_type(self, form_visualization_type):
        ...
        self.get_element_by_xpath(
            ColumnsAndFiltersSelectionMacDesktopPage.ATTRIBUTE_FORM_DROPDOWN_ITEM % form_visualization_type).click()
    ...
    def click_attributes_and_forms(self, attributes_and_forms_json):
        for attribute_name, attribute_forms in json.loads(attributes_and_forms_json).items():
            unchecked_attribute_checkbox = ColumnsAndFiltersSelectionMacDesktopPage.ATTRIBUTE_CHECKBOX_UNCHECKED

            checked_attribute_checkbox = ColumnsAndFiltersSelectionMacDesktopPage.ATTRIBUTE_CHECKBOX_CHECKED

            self.get_element_by_xpath(unchecked_attribute_checkbox % attribute_name).click()

            self.get_element_by_xpath(checked_attribute_checkbox % attribute_name).click(
            ...
            for attribute_form in attribute_forms:
                self.get_element_by_xpath(unchecked_attribute_checkbox % attribute_form).click()
