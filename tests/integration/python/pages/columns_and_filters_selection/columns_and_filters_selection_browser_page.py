...
class ColumnsAndFiltersSelectionBrowserPage(BaseBrowserPage):
    ...
    IMPORT_BUTTON_ELEM = '.popup-buttons.popup-footer > button:nth-child(2)'
    ...
    def click_import_button_without_success_check(self):
        ...
        self.get_element_by_css(ColumnsAndFiltersSelectionBrowserPage.IMPORT_BUTTON_ELEM).click()
