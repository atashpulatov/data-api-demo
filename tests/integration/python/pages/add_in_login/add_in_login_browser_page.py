...
class AddInLoginBrowserPage(BaseBrowserPage):
    ...
    def login(self, username, password):
        ...
        username_field = self.get_element_by_id(
            AddInLoginBrowserPage.USERNAME_INPUT_ELEM)
        username_field.send_keys_with_check(username)

        password_field = self.get_element_by_id(
            AddInLoginBrowserPage.PASSWORD_INPUT_ELEM)
    ...
    def verify_authentication_error_and_click_ok(self):
        ...
        self.find_element_in_list_by_text(
            AddInLoginBrowserPage.AUTH_ERROR_TITLE_ELEM, AddInLoginBrowserPage.AUTH_ERROR_TITLE_TEXT)
    ...
    def verify_plugin_privileges_message_and_click_try_again(self):
        ...
        self.find_element_in_list_by_text(
            AddInLoginBrowserPage.PRIVILEGES_ERROR_MESSAGE_ELEM, AddInLoginBrowserPage.PRIVILEGES_ERROR_MESSAGE_TEXT)
