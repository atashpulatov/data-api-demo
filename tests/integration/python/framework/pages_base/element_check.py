...
class ElementCheck:
    ...
    def check_if_element_exists_by_name(self, selector, timeout=DEFAULT_TIMEOUT, image_name=None):
        return self.get_element_center_coordinates_by_name(selector, timeout, image_name) is not None
    ...
    def check_if_element_exists_by_id(self, selector, timeout=DEFAULT_TIMEOUT, image_name=None):
        return self.get_element_center_coordinates_by_id(selector, timeout, image_name=None) is not None
