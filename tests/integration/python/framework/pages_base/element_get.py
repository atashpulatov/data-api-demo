...
class ElementGet(ElementCheck):
    ...
    def get_element_by_xpath(self, selector, timeout=DEFAULT_TIMEOUT, image_name=None):
        if image_name and self.image_recognition_enabled:
            return ImageElement(
                self.get_element_center_coordinates_by_xpath(selector, timeout, image_name), self.driver, image_name
            )
        else:
    ...
    def get_element_by_class_name(self, selector, timeout=DEFAULT_TIMEOUT, image_name=None):
        if image_name and self.image_recognition_enabled:
            return ImageElement(
                self.get_element_center_coordinates_by_class_name(selector, timeout, image_name),
                self.driver,
                image_name
            )
        else:
    ...
    def get_element_by_name(self, selector, timeout=DEFAULT_TIMEOUT, image_name=None):
        if image_name and self.image_recognition_enabled:
            return ImageElement(
                self.get_element_center_coordinates_by_name(selector, timeout, image_name), self.driver, image_name
            )
        else:
    ...
    def get_element_by_accessibility_id(self, selector, timeout=DEFAULT_TIMEOUT, image_name=None):
        if image_name and self.image_recognition_enabled:
            return ImageElement(
                self.get_element_center_coordinates_by_mobile_accessibility_id(selector, timeout),
                self.driver,
                image_name
            )
        else:
