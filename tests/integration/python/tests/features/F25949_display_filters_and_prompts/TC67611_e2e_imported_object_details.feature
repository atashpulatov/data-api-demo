  ...
  Scenario: [TC67611] - Imported object details E2E
    Given I initialized Excel
     ...
     Then I verified that object 1 is certified
      And I verified that object 1 has "Attribute" list displayed
      And I verified that object 1 has "Metric" list displayed
      And I verified that object 1 has id "3633950911EAA96889F00080EF25F8A4"
     ...
     Then I verified that object 1 has "Attribute" list with value "adult male, age, alive, alone, class, deck, embark town, embarked, sex, who"
      And I verified that object 1 has "Metric" list with value "fare, parch, pclass, Row Count - titanic_df, sibsp, survived"
      And I verified that object 1 has full location "MicroStrategy Tutorial > Public Objects > Reports > DS Objects > Cubes for Create Testing > testing_folder_wiblgjlprj > titanic_wiblgjlprj" displayed
     ...
     Then I verified that object 1 has "Prompt" list displayed
      And I verified that object 1 has "Filter" list displayed
      And I verified that object 1 has "Attribute" list displayed
      And I verified that object 1 has "Metric" list displayed
      And I verified that object 1 has id "4BF6385A11EA638B25610080EFC58CB1"

     When I clicked "Filter" list expand button on object 1
      And I clicked "Attribute" list expand button on object 1
      And I clicked object location expand button on object 1

     Then I verified that object 1 has "Filter" list with value "Call Center (Atlanta, San Diego, San Francisco, Washington, DC, Salt Lake City, Miami, Milwaukee, New Orleans, Seattle, Boston, New York, Fargo, Memphis, Charleston, Web), Employee (Bates, Becker, Bell, Benner, Bernstein, Brown, Conner, Corcoran, De Le Torre, Ellerkamp, Folks, Gale, Gedot, Hall, Hollywood, Hunt, Ingles, Johnson, Kelly, Kieferson, Lynch, McClain, Nelson, Pierce, Sawyer, Schafer, Smith, Sonder, Strome, Torrison, Yager, Young, Zemlicka, Walker)"
      And I verified that object 1 has "Attribute" list with value "Call Center, Country, Distribution Center, Employee, Region"
      And I verified that object 1 has full location "MicroStrategy Tutorial > Public Objects > Reports > _Centralised Main Folder > Prompted report with subtotals" displayed
     ...
     Then I verified that object 3 has "Filter" list with value "age (0.42, 0.67, 0.75, 0.83, 0.92, 1, 10, 11, 12, 13, 14, 14.5, 15, 16, 17, 18, 19, 2, 20, 20.5, 21, 22, 23, 23.5, 24, 24.5, 25, 26, 27, 28, 28.5, 29, 3, 30, 30.5, 31, 32, 32.5, 33, 34, 34.5, 35, 36, 36.5, 37, 38, 39, 4, 40, 40.5, 41, 42, 43, 44, 45, 45.5, 46, 47, 48, 49, 5, 50, 51, 52, 53, 54, 55, 55.5, 56, 57, 58, 59, 6, 60, 61, 62, 63, 64, 65, 66, 7, 70, 70.5, 71, 74, 8, 80, 9, NA)"
      And I verified that object 3 has "Attribute" list with value "alive, who, alone, deck, class, adult male, embarked, embark town, sex, age"
      And I verified that object 3 has full location "MicroStrategy Tutorial > Public Objects > Reports > DS Objects > Cubes for Create Testing > testing_folder_wiblgjlprj > titanic_wiblgjlprj" displayed
     ...
     Then I verified that object 1 has collapsed "Prompt" list displayed
      And I verified that object 1 has collapsed "Filter" list displayed
     ...
     Then I verified that object 2 has collapsed "Prompt" list displayed
      ...
      And I verified that object 2 has id "5902C03A11E9FEF1DC670080EF856919"

     When I clicked toggle details button on object 3
     Then I verified that object 3 has collapsed "Prompt" list displayed
      And I verified that object 3 has collapsed "Filter" list displayed
      And I verified that object 3 has collapsed "Attribute" list displayed
      And I verified that object 3 has collapsed "Metric" list displayed
      And I verified that object 3 has collapsed location displayed
      And I verified that object 3 has id "4BF6385A11EA638B25610080EFC58CB1"

     When I clicked toggle details button on object 4
     Then I verified that object 4 is certified
      And I verified that object 4 has collapsed "Attribute" list displayed
      And I verified that object 4 has collapsed "Metric" list displayed
      And I verified that object 4 has collapsed location displayed
      And I verified that object 4 has id "3633950911EAA96889F00080EF25F8A4"
