  ...
  Scenario: [TC67486] - Imported objects details showing, hiding and updating
    Given I initialized Excel
     ...
     Then I verified that object 1 has "Prompt" list displayed
      And I verified that object 1 has "Prompt" list with value "Northeast, 1/1/2014"
      And I verified that object 1 has "Attribute" list displayed
      And I verified that object 1 has "Attribute" list with value "Quarter, Distribution Center"
      And I verified that object 1 has "Metric" list displayed
      And I verified that object 1 has "Metric" list with value "Profit, Revenue"
      And I verified that object 1 has id "5902C03A11E9FEF1DC670080EF856919"
      And I verified that object 1 has owner "Administrator"
    ...
    # TODO: Should check if object is highlighted
     ...
     Then I verified that object 2 has "Prompt" list displayed
      And I verified that object 2 has "Prompt" list with value "Books"
      And I verified that object 2 has "Attribute" list displayed
      ...
      And I verified that object 2 has "Metric" list displayed
      And I verified that object 2 has "Metric" list with value "Cost, Profit, Profit Margin, Revenue, Units Sold"
      And I verified that object 2 has id "4BF6385A11EA638B25610080EFC58CB1"
      And I verified that object 2 has owner "Administrator"
     ...
     Then I verified that object 2 has "Prompt" list with value "Books"
      And I verified that object 2 has "Attribute" list with value "Country, Region"
      And I verified that object 2 has "Metric" list with value "Cost, Revenue"
      And I verified that object 2 has id "4BF6385A11EA638B25610080EFC58CB1"
      And I verified that object 2 has owner "Administrator"
    ...
    Given I ensured object "4BF6385A11EA638B25610080EFC58CB1" in Tutorial project is certified
     ...
     Then I verified that object 1 has details panel hidden
      And I verified that object 2 has details panel hidden

     When I clicked toggle details button on object 1

     Then I verified that object 1 has "Prompt" list with value "Northeast, 1/1/2014"
      And I verified that object 1 has "Attribute" list with value "Quarter, Distribution Center"
      And I verified that object 1 has "Metric" list with value "Profit, Revenue"
      And I verified that object 1 has id "5902C03A11E9FEF1DC670080EF856919"
      And I verified that object 1 has owner "Administrator"
