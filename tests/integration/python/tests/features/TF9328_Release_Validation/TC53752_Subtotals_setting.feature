...
Feature: TS41441 - Sanity checks
  ...
  Scenario: [TC62630] - [Privileges] Log in with different users with different permissions (Office, Library, Web)
    Given I logged in as default user
     ...
     Then cells ["B1", "D2"] should have values ["Item Type", "385383069"]
     ...
     When I added a new worksheet
      And I clicked Add Data button
      And I found object by ID "93E7685C11EA638E201A0080EF65CAAE" and selected "Report Totals Subtotals 1"
      And I clicked Prepare Data button
      And I waited for Run button to be enabled
      And I clicked Run button
      And I verified that Columns & Filters Selection is visible
     ...
     Then cells ["B1", "D2"] should have values ["Subcategory", "$1,419"]
      ...
      And cells ["B1", "D2"] should have values ["Subcategory", "$1,419"]
     ...
     When I clicked Add Data button
      ...
      And I clicked Prepare Data button
      #  TODO Then I verified subtotal toggle is invisible
     ...
     When I clicked Back button
      And I cleared search box
      And I found object by ID "693833FC11EA64517EC80080EF0592AE" and selected "Prompted report without subtotals"
      And I clicked Prepare Data button
