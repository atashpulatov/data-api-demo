...
Feature: TF9328 - Release Validation
  ...
  Scenario: [TC40305] - Selecting objects imported to the different worksheets and to adjacent columns/rows
    Given I logged in as default user
     ...
     When I found object by ID "A6E8885611E99CC31A6E0080EFF50C15" and selected "Report with crosstab 123"
      And I clicked Import button
      And I closed last notification
      And cells ["B3", "E5", "V6"] should have values ["", "$ 7,382", "$1,405"]
