Feature: Time duration demo
  ...
  Scenario: Time duration demo
    Given I saved execution start time to "timer_1_label"
     ...
     Then I verified that execution time "timer_2_label" is similar to "timer_1_label" with "7.3" seconds threshold
      And I verified that execution time "timer_1_label" is not longer than "timer_2_label"
