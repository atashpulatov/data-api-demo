...
Feature: F30479 - Hardening of importing data from Dossier to Excel
  ...
  Scenario: [TC65052] E2E Hardening of importing data from Dossier to Excel
    Given I logged in as default user
     ...
     When I saved execution start time to "visualisation_not_filtered_import_duration"
     ...
     Then I verified that execution time "visualisation_only_2014_import_duration" is not longer than "visualisation_not_filtered_import_duration"
