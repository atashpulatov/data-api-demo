...
Feature: TS41441 - Sanity checks
  ...
  Scenario: [TC59464] - Binding
    Given I logged in as default user
      ...
      And I found object with complex name and select it by ID "28185E364F4B1CA6E8FA178214FDC3AE"
     ...
     When I selected cell "K1"
      ...
      And I found object with complex name and select it by ID "C2B08DA411EA441130640080EF154C73" 
      And I clicked Import button
      And I closed all notifications
