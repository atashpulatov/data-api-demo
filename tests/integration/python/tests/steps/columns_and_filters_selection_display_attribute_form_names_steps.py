...
def step_impl(context, form_visualization_type):
    context.pages.display_attribute_form_names_page().select_display_attributes_form_names_element(
...
def step_impl(context):
    context.pages.display_attribute_form_names_page().select_first_display_attributes_form_names_element()


@step('I verified that the background color of the first option in Display attribute form names is "{color}"')
def step_impl(context, color):
    found_color = context.pages.display_attribute_form_names_page(). \
