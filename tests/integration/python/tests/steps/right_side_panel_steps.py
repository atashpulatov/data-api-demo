...
@step('I toggled the "{option}" setting to "{value}"')
def step_impl(context, option, value):
    context.pages.right_panel_page().toggle_setting(option, value)


@step('I verified "{option}" setting is OFF')
def step_impl(context, option):
    is_option_checked = context.pages.right_panel_page().is_toggle_option_checked(option)
    AssertUtil.assert_simple(is_option_checked, False)


@step('I verified "{option}" setting is ON')
def step_impl(context, option):
    is_option_checked = context.pages.right_panel_page().is_toggle_option_checked(option)
