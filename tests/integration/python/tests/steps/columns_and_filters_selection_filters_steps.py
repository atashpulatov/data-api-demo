...
@step('I scrolled into filter element number {object_number}')
def step_impl(context, object_number):
    context.pages.columns_and_filters_selection_filters_page().scroll_into_filter_by_number(object_number)
