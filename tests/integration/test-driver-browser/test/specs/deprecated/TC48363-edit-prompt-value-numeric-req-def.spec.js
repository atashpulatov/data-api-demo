...
describe('[TC48363] Editing a prompted report (with prompt - Value|Numeric|Required|Default answer', function() {
  beforeAll(async () => {
  ...
  it('TC48363] should edit a report', async () => {
    //should import prompted report
    await OfficeWorksheet.selectCell('A1');
    await PluginRightPanel.clickImportDataButton();
    await PluginPopup.importPromptDefault(o.reports.numericPromptedReport);
