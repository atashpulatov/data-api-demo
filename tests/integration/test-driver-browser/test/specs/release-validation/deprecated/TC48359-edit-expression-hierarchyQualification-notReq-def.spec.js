...
describe('[TC48359] Editing a prompted report (with prompt - Expression|Hierarchy Qualification|Not required|Default answer)', function() {
  beforeAll(async () => {
  ...
  it('[TC48359] should edit a report', async () => {
