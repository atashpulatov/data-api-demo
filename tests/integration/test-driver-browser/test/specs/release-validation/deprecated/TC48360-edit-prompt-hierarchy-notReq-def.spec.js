...
describe('[TC48360] Editing a prompted report (with prompt - Hierarchy|Not required|Default answer)', function() {
  beforeAll(async () => {
  ...
  it('[TC48360] should edit a report', async () => {
    //should import report
    await OfficeWorksheet.selectCell('A1');
    await PluginRightPanel.clickImportDataButton();
    await PluginPopup.importPromptDefault(o.reports.hierarchyPromptedReport);
