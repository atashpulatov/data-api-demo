...
export const popupSelectors = {
  ...
  filterCheckbox: (section, item) => `.category-list-header[aria-label="${section}"] + .category-list-table > .category-list-row > .checkbox-cell > label > input[aria-label="Checkbox for ${item}."] + span`,
