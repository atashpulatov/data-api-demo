...
export const popupSelectors = {
  ...
  locationDetail: '.details-table tr:nth-of-type(4) .ellipsis-container',
  descriptionDetail: '.details-table tr:nth-of-type(5) .ellipsis-container',
  locationDetailTooltip: '.details-table tr:nth-of-type(4) .tooltiptext',
  descriptionDetailTooltip: '.details-table tr:nth-of-type(5) .tooltiptext',
