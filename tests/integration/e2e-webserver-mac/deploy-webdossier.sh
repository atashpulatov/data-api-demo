...
sed -i 's+<session-timeout>30</session-timeout>+<session-timeout>30</session-timeout> <http-only>true</http-only><secure>true</secure>+g' /usr/local/tomcat/webapps/web-dossier/WEB-INF/web.xml
